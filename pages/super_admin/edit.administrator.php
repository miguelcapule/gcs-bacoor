                                        ...
                                        <div class="row mb-4 mt-5">
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="admin_fname"
                                                    value="<?php echo $row['admin_fname']?>" placeholder="First name">
                                            </div>
                                            ...
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="admin_mname"
                                                    value="<?php echo $row['admin_mname']?>" placeholder="Middle name">
                                            </div>
                                            ...
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="admin_lname"
                                                    value="<?php echo $row['admin_lname']?>" placeholder="Last name">
                                            </div>
                                        </div>
