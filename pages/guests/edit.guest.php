...
<head>
    ...
    <title>Edit Guest | GCS Bacoor</title>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="card">
                                <form action="userData/ctrl.edit.guest.php?guest_id=<?php echo $guest_id;?>" enctype="multipart/form-data" method="POST">
                                    <div class="card-header">
                                        <h3 class="card-title">Guest Info</h3>
                                    </div>
                                    <?php
                                        $guest_info = mysqli_query($conn, "SELECT * FROM tbl_guests WHERE guest_id = '$guest_id'");
                                        ...
                                        <div class="row mb-4 mt-5">
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="guest_fname"
                                                    value="<?php echo $row['guest_fname']?>" placeholder="First name" required>
                                            </div>
                                            ...
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="guest_mname"
                                                    value="<?php echo $row['guest_mname']?>" placeholder="Middle name">
                                            </div>
                                            ...
                                            <div class="input-group col-sm-4 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="guest_lname"
                                                    value="<?php echo $row['guest_lname']?>" placeholder="Last name" required>
                                            </div>
                                        </div>
