...
$pdf->Image('../../docs/assets/img/logo2.jpg', 45, 8, 15, 15);
// text color
...
$pdf->SetFont('Arial', '', 9);
$pdf->Cell(8, 4, '', 0, 0); // space 
$pdf->Cell(28, 4, '', 0, 0); // date of birth
$pdf->Cell(8, 4, '', 0, 0); // space 
$pdf->Cell(28, 4, '', 0, 0); // place birth
$pdf->Cell(9, 4, '', 0, 0); // space 
$pdf->Cell(28, 4, '', 0, 0); //  sex
$pdf->Cell(10, 4, '', 0, 0); // space 
...
$pdf->Cell(45, 5, '', 0, 0); // data
$pdf->Cell(15, 2, '', 0, 0); // SPACE
$pdf->Cell(45, 5, '', 0, 0); // data
$pdf->Cell(15, 2, '', 0, 0); // SPACE
$pdf->Cell(30, 5, '', 0, 1); // data
//////////////////////////   data po
$pdf->SetFont('Arial', '', 9);
$pdf->Ln(1);
$pdf->Cell(25, 2, '', 0, 0); // SPACE
...
$pdf->Cell(15, 8, '', 0, 1); // data graduated
...
$pdf->Cell(65, 7, '', 0, 0); // SPACE graduated
$pdf->Cell(15, 6, '', 0, 1); // data graduated
...
$pdf->Cell(10, 2, '', 0, 0); // SPACE
$pdf->Cell(30, 8, '(Giving false information will make me ineligible foe enrollment of be subject to dismissal. All information', 0, 1);
$pdf->Cell(10, 2, '', 0, 0); // SPACE
